    ...
    <div className="min-h-screen bg-slate-50">
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-12">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">
              Find Classical Music Concerts & Piano Recitals Near You
            </h1>
            <p className="text-white font-medium text-lg">
              Discover upcoming classical performances, vote for your favorites, and connect with fellow music lovers
            </p>
            <div className="mt-4 text-white/80 text-sm">
              <span>Piano Concerts</span> • <span>Chamber Music</span> • <span>Orchestral Performances</span> • <span>Recitals</span>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8" role="main">
        ...
        <section aria-labelledby="featured-concert" className="mb-8">
          <h2 id="featured-concert" className="sr-only">Featured Classical Concert</h2>
          <FeaturedConcert
        ...
        {sessionId && (
          <section aria-labelledby="user-achievements" className="mb-8 bg-white rounded-lg shadow-sm border border-slate-200 p-6">
            <h2 id="user-achievements" className="sr-only">Your Music Engagement Achievements</h2>
        ...
        <section aria-labelledby="concert-rankings" className="mb-8">
          <h2 id="concert-rankings" className="text-2xl font-bold text-slate-800 mb-6 text-center">
        ...
        <section className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 mb-8">
          <div className="prose max-w-none">
            ...
            <p className="text-slate-600 mb-4">
              Find the most anticipated classical music performances, piano recitals, and chamber music concerts. 
              Our community-driven platform helps you discover talented artists and upcoming events in your area.
            </p>
            
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Piano Concerts & Recitals</h3>
                <p className="text-slate-600">
                  Experience world-class piano performances featuring classical masterpieces, contemporary compositions, 
                  and emerging artists. Vote for your favorite pianists and help others discover exceptional talent.
                </p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Chamber Music Events</h3>
                <p className="text-slate-600">
                  Intimate chamber music performances showcasing string quartets, violin sonatas, cello recitals, 
                  and ensemble pieces. Connect with fellow classical music enthusiasts and share your recommendations.
                </p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Orchestra Concerts</h3>
                <p className="text-slate-600">
                  Full orchestral performances featuring symphonies, concertos, and classical repertoire. 
                  Stay updated on concert schedules and find the best seats for upcoming performances.
                </p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold text-slate-800 mb-3">Community Engagement</h3>
                <p className="text-slate-600">
                  Join our community of classical music lovers. Vote on upcoming concerts, earn achievement badges, 
                  and help create rankings that guide others to exceptional musical experiences.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                <li><a href="#" className="hover:text-white">Piano Recitals</a></li>
                <li><a href="#" className="hover:text-white">Chamber Music</a></li>
                <li><a href="#" className="hover:text-white">Orchestra Concerts</a></li>
                <li><a href="#" className="hover:text-white">Violin Performances</a></li>
                <li><a href="#" className="hover:text-white">Cello Recitals</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                <li><a href="#" className="hover:text-white">Concert Halls</a></li>
                <li><a href="#" className="hover:text-white">Music Conservatories</a></li>
                <li><a href="#" className="hover:text-white">University Venues</a></li>
                <li><a href="#" className="hover:text-white">Community Centers</a></li>
                <li><a href="#" className="hover:text-white">Outdoor Venues</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                <li><a href="#" className="hover:text-white">Baroque Music</a></li>
                <li><a href="#" className="hover:text-white">Romantic Period</a></li>
                <li><a href="#" className="hover:text-white">Contemporary Classical</a></li>
                <li><a href="#" className="hover:text-white">Modern Compositions</a></li>
                <li><a href="#" className="hover:text-white">Jazz Classical Fusion</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-300">
                <li><a href="#" className="hover:text-white">Concert Reviews</a></li>
                <li><a href="#" className="hover:text-white">Artist Profiles</a></li>
                <li><a href="#" className="hover:text-white">Concert Calendar</a></li>
                <li><a href="#" className="hover:text-white">Music Education</a></li>
                <li><a href="#" className="hover:text-white">Subscribe to Updates</a></li>
              </ul>
            </div>
          </div>
